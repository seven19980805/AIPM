...
export const structuredRequirementPanelCopy = {
  en: {
    ...
    prdV0Ready: 'Go Coding ready',
    prdV0ReadyHelp: 'Enough requirement information has been collected. AIPM can generate documents and open Vibe Coding.',
    fastPath: {
      title: 'Readiness path',
      help: 'Send a seed, answer focused expert questions, then open Go Coding once the requirement is ready.',
      done: 'Done',
      current: 'Now',
      pending: 'Next',
  ...
  de: {
    ...
    prdV0ReadyHelp: 'Die Anforderung ist vollstaendig genug. AIPM kann Dokumente erzeugen und Vibe Coding oeffnen.',
    fastPath: {
      title: 'Readiness-Pfad',
      help: 'Seed senden, fokussierte Expertenfragen beantworten, dann Go Coding bei ausreichender Anforderung oeffnen.',
      done: 'Fertig',
      current: 'Jetzt',
      pending: 'Naechst',
  ...
  zh: {
    ...
    prdV0Ready: 'Go Coding 已就绪',
    prdV0ReadyHelp: '需求信息已足够，AIPM 可以生成文档并打开 Vibe Coding。',
    fastPath: {
      title: '信息充分度路径',
      help: '发送一句话种子，继续回答专家链路问题；信息足够后再打开 Go Coding。',
      done: '完成',
      current: '当前',
      pending: '下一步',
      ...
      steps: {
        ...
        handoff: {
          label: '打开 Vibe Coding',
          help: 'Vibe Coding 可读取生成文档和交接清单；状态不会自动回传。',
        },
      },
    },
    goCoding: '打开 Vibe Coding',
  ...
  ms: {
    ...
    prdV0Ready: 'Go Coding ready',
    prdV0ReadyHelp: 'Maklumat requirement sudah cukup. AIPM boleh jana dokumen dan buka Vibe Coding.',
    fastPath: {
      title: 'Readiness path',
      help: 'Hantar seed, jawab soalan pakar yang fokus, kemudian buka Go Coding apabila requirement ready.',
      done: 'Selesai',
      current: 'Kini',
      pending: 'Seterus',
